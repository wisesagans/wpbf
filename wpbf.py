...
if len(sys.argv) <= 1:
    print 'WP-crack v1.0 (c)2012 by AditArlos - a very fast logon WordPress Cracker'
    print 'author: Adit Arlos'
    print 'Mail   : aditexploiter@gmail.com'
    print ''
...
print 'WP-crack 1.0 (c)2012 by Adit Arlos - a very fast logon WordPress Cracker'
print 'author: Adit Arlos'
print 'Mail   : aditexploiter@gmail.com'
